...
public class Review {
	...
	private static void f3() {
		...
		// 1.구현 class 사용
		// btnOk.setClickListener(new Button());
		// 2.익명
...
//	});
	...
	private static void f1() {
		Makeable make1 = (n, s) -> new Student(n, s);
		Makeable make2 = Student::new;
		Makeable make3 = new Makeable() {
			public Student makeStudent(String name, int score) {
				return new Student(name, score);
			}
		};
		Makeable make4 = new StudentMakeClass();
		Student s1 = make1.makeStudent("상호", 100);
		Student s2 = make1.makeStudent("상호2", 200);
